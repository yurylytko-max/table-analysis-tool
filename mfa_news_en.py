...
PAGE_URL = f"{BASE_URL}/en/press/news_mfa/"
API_URL = f"{BASE_URL}/press/news_mfa/json/?get_more_news"
OUTPUT_FILE = Path("mfa_news_en.csv")
MAX_PAGES = 5000
RETRIES = 3
LIST_DELAY_MIN = 0.25
LIST_DELAY_MAX = 0.45
...
def extract_content(html: str) -> str:
    match = re.search(
        r'<span class="date _big">.*?</span>(.*?)(?:<p>\s*<a href="/print/en/press/news_mfa/|<div class="content-page__social")',
        html,
        flags=re.S | re.I,
    )
    if not match:
